...
const Inscription = () => {
  ...
  const canNext = (): boolean => {
    switch (step) {
      ...
      case 4: return data.a_projet === 'non' || (!!data.nom_projet && !!data.domaine_projet && !!data.problematique && !!data.solution);
      case 5: return !!data.niveau_technique && data.competences_equipe.length > 0;
      case 6: return !!data.motivation && !!data.esperances && !!data.source_info;
      default: return true;
    }
  };
