...
const Etape1Couverture = ({ data, onChange, errors = {} }: Props) => (
  <div className="space-y-8">
    ...
    <div className="grid sm:grid-cols-3 gap-6">
      ...
      <motion.div 
        className="bg-white rounded-2xl border border-[#E9ECEF] p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-[#24366E]/50"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-[#24366E]/10 to-[#2E4A8C]/10 flex items-center justify-center">
            <MapPin size={20} className="text-[#24366E]" />
          </div>
          <div>
            <h3 className="font-display text-lg font-bold text-[#212529]" style={{ fontFamily: 'Sora, sans-serif' }}>
              ESMT, Dakar
