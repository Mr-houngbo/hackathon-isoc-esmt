...
const Etape4Membres = ({ data, onChange, errors = {} }: Props) => {
  ...
  const getBlockBorderColor = (membre: any, index: number) => {
    ...
    if (isBlockValid(membre)) return 'border-[#40B2A4]';
  ...
  return (
    <div className="space-y-8">
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  isBlockValid(membre) ? 'bg-[#40B2A4]' : 'bg-[#E9ECEF]'
                }`}>
                            ...
                            <button
                              ...
                              className={`px-2 py-1 rounded-lg text-xs font-semibold transition-all ${
                                membre.genre === genre
                                  ...
                                  : 'bg-[#E9ECEF] border border-[#E9ECEF] text-[#6C757D] hover:border-[#40B2A4]/30'
                              }`}
                              style={{ fontFamily: 'DM Sans, sans-serif' }}
                            >
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-[#40B2A4]/10 to-[#40B2A4]/10 rounded-2xl border border-[#E9ECEF] p-4"
      >
        <p 
