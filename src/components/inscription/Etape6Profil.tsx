  ...
  return (
    <div className="space-y-8">
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="text-center">
                  <span 
                    ...
                    style={{ fontFamily: 'Sora, sans-serif' }}
                  >
                    <span className={data.niveau_technique === niveau.value ? 'text-[#40B2A4]' : 'text-[#212529]'}>
                      {niveau.label}
                    </span>
                  </span>
                  <span 
                    ...
                    style={{ fontFamily: 'DM Sans, sans-serif' }}
                  >
                    <span className={data.niveau_technique === niveau.value ? 'text-[#40B2A4]' : 'text-[#6C757D]'}>
                      {niveau.desc}
                    </span>
                  </span>
                </div>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-[#40B2A4]/10 to-[#24366E]/10 rounded-2xl border border-[#E9ECEF] p-4"
      >
        <p 
