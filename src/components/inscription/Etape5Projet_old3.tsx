        ...
        <label className="block">
          ...
          <div className="flex justify-between items-center mt-2">
            <span 
              ...
              style={{ fontFamily: 'DM Sans, sans-serif' }}
            >
              {wordCount(data.projet_description)} mots
            </span>
            <span 
              className="text-xs text-[#6C757D]"
              style={{ fontFamily: 'DM Sans, sans-serif' }}
      ...
      >
        <label className="block">
          <span 
            ...
            style={{ fontFamily: 'Sora, sans-serif' }}
          >
            Problème résolu <span className="text-[#DC2626]">*</span>
          </span>
          <textarea
            value={data.projet_probleme_resolu}
      ...
      >
        <label className="block">
          <span 
            ...
            style={{ fontFamily: 'Sora, sans-serif' }}
          >
            Point d'innovation <span className="text-[#DC2626]">*</span>
          </span>
          <textarea
            value={data.projet_innovation}
