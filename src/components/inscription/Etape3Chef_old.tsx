...
const competencesList = [
  { value: 'Dev Web', icon: Code, color: 'text-[#FF6B35]' },
  { value: 'Dev Mobile', icon: Phone, color: 'text-[#1E3A5F]' },
  { value: 'Design UI-UX', icon: User, color: 'text-[#FF6B35]' },
  { value: 'Data', icon: Code, color: 'text-[#1E3A5F]' },
  { value: 'IA', icon: Code, color: 'text-[#FF6B35]' },
  { value: 'Business', icon: Briefcase, color: 'text-[#1E3A5F]' },
  { value: 'Communication', icon: User, color: 'text-[#FF6B35]' },
      ...
      >
        <label className="flex items-center gap-4 cursor-pointer">
          <input
            ...
            className="h-5 w-5 rounded border border-[#E9ECEF] bg-white text-[#FF6B35] focus:ring-2 focus:ring-[#FF6B35]/20 focus:ring-offset-0"
          />
          <div>
            <span 
