    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-6 text-left">
        ...
        <div className="space-y-4">
          <div>
            <h4 
              className="font-display text-sm font-semibold text-[#FF6B35] mb-2"
              style={{ fontFamily: 'Sora, sans-serif' }}
            >
              Type de candidature
            </h4>
        ...
        <div className="space-y-4">
          <div>
            <h4 
              className="font-display text-sm font-semibold text-[#1E3A5F] mb-2"
              style={{ fontFamily: 'Sora, sans-serif' }}
            >
              Événement
            </h4>
    ...
    >
      ...
      <div className="flex justify-center gap-6">
        <a 
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#FF6B35]/10 to-[#1E3A5F]/10 rounded-xl hover:from-[#FF6B35]/20 hover:to-[#1E3A5F]/20 transition-all duration-300"
        >
          <Instagram size={18} className="text-[#FF6B35]" />
          <span 
        ...
        <a 
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#FF6B35]/10 to-[#1E3A5F]/10 rounded-xl hover:from-[#FF6B35]/20 hover:to-[#1E3A5F]/20 transition-all duration-300"
        >
          <Linkedin size={18} className="text-[#1E3A5F]" />
          <span 
            className="text-sm font-medium text-[#212529]"
            style={{ fontFamily: 'DM Sans, sans-serif' }}
          >
