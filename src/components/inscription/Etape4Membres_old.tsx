        ...
        {data.membres.map((membre, idx) => (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#FF6B35]/10 to-[#1E3A5F]/10 flex items-center justify-center">
                <UserIcon size={16} className="text-[#FF6B35]" />
              </div>
            </div>
