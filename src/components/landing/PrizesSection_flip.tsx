        ...
        <div className="p-8 text-center">
          ...
          >
            ...
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${
              prize.color === 'orange' 
                ? 'bg-[#40B2A4]/10 text-[#40B2A4] border border-[#40B2A4]/30' 
      ...
      >
        <div className="bg-white rounded-2xl border border-[#E9ECEF] shadow-lg p-8 max-w-2xl mx-auto">
          <p 
            ...
            style={{ fontFamily: 'DM Sans, sans-serif' }}
          >
            Au total : <span className="text-[#40B2A4] font-bold text-xl">450 000 FCFA</span> de prix + incubation
          </p>
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[#24366E]/10 border border-[#24366E]/20">
              <Crown className="h-5 w-5 text-[#40B2A4]" />
