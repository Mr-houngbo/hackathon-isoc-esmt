        ...
        <div className="p-8 text-center">
          ...
          <div className="relative mb-6 inline-flex">
            ...
            <div className={`relative h-16 w-16 rounded-full bg-gradient-to-br ${
              prize.color === 'orange' 
                ? 'from-[#FF6B35]/10 to-[#FF8C42]/10' 
                : 'from-[#1E3A5F]/10 to-[#2C5282]/10'
            } border-2 ${
              prize.color === 'orange' 
                ? 'border-[#FF6B35]/30' 
                : 'border-[#1E3A5F]/30'
              ...
              <prize.icon className={`h-8 w-8 ${
                prize.color === 'orange' ? 'text-[#FF6B35]' : 'text-[#1E3A5F]'
              }`} />
            </div>
          </div>
          ...
          >
            ...
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${
              prize.color === 'orange' 
                ...
                : 'bg-[#1E3A5F]/10 text-[#1E3A5F] border border-[#1E3A5F]/30'
            }`}>
              {prize.bonus}
            </div>
          </motion.div>
      ...
      >
        <div className="bg-white rounded-2xl border border-[#E9ECEF] shadow-lg p-8 max-w-2xl mx-auto">
          <p 
            ...
            style={{ fontFamily: 'DM Sans, sans-serif' }}
          >
            Au total : <span className="text-[#FF6B35] font-bold text-xl">450 000 FCFA</span> de prix + incubation
          </p>
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[#1E3A5F]/10 border border-[#1E3A5F]/20">
              <Crown className="h-5 w-5 text-[#FF6B35]" />
              <span className="text-sm font-semibold text-[#1E3A5F]" style={{ fontFamily: 'Sora, sans-serif' }}>
